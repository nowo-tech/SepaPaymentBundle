...
class MandateTest extends TestCase
{
    ...
    /**
     * Covers getExpirationDate returning cached value when explicitly set (return $this->expirationDate branch).
     */
    public function testGetExpirationDateReturnsSetValue(): void
    {
        $mandate = new Mandate(
            'MANDATE-001',
            new DateTime('2024-01-15'),
        ...
        $custom = new DateTime('2026-12-31');
        $mandate->setExpirationDate($custom);
        $this->assertSame($custom, $mandate->getExpirationDate());
        $this->assertSame($custom, $mandate->getExpirationDate());
    }
    ...
    /**
     * Covers getRevocationDate and getRevocationReason when mandate was never revoked (return null).
     */
    public function testGetRevocationDateAndReasonReturnNullWhenNotRevoked(): void
    {
        $mandate = new Mandate(
            'MANDATE-001',
            new DateTime(),
        ...
        $this->assertNull($mandate->getRevocationDate());
        $this->assertNull($mandate->getRevocationReason());
    }
    ...
    /**
     * Covers isExpired with explicit checkDate (past and future).
     */
    public function testIsExpiredWithExplicitCheckDate(): void
    {
        $mandate = new Mandate(
            'MANDATE-001',
            new DateTime('2024-01-01'),
        ...
        $mandate->setExpirationDate(new DateTime('2025-12-31'));
        $this->assertFalse($mandate->isExpired(new DateTime('2025-01-01')));
        $this->assertTrue($mandate->isExpired(new DateTime('2026-06-01')));
    }

    /**
     * Covers isExpired when getExpirationDate returns null (branch return false).
     * Uses a subclass that overrides getExpirationDate to return null.
     */
    public function testIsExpiredReturnsFalseWhenExpirationDateIsNull(): void
    {
        ...
        $this->assertFalse($mandate->isExpired());
        $this->assertFalse($mandate->isExpired(new DateTime('2030-01-01')));
    }
}
